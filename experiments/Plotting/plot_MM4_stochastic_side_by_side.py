...
file_directory = os.path.join(os.getcwd(), "..", "Results", "MM4_v7")
...
plt.savefig(
    os.path.join(
        os.getcwd(), "..", "Images", "MM4_v7", "MM4_" + str(dimension) + "_dim_v7.pdf"
    ),
    bbox_inches="tight",
)
plt.close()
...
plot_stochastic(
    ...
    save_figure=os.path.join(
        ...
        "Images",
        "MM4_v7",
        "MM4_differential_training_" + str(dimension) + "_dim_v7.pdf",
    ),
)
plt.close()
...
plot_stochastic(
    ...
    save_figure=os.path.join(
        ...
        "Images",
        "MM4_v7",
        "MM4_integral_training_" + str(dimension) + "_dim_v7.pdf",
    ),
)
plt.close()
...
plot_stochastic(
    ...
    save_figure=os.path.join(
        ...
        "Images",
        "MM4_v7",
        "MM4_differential_validation_" + str(dimension) + "_dim_v7.pdf",
    ),
)
plt.close()
...
plot_stochastic(
    ...
    save_figure=os.path.join(
        ...
        "Images",
        "MM4_v7",
        "MM4_integral_validation_" + str(dimension) + "_dim_v7.pdf",
    ),
)
plt.close()
