...
file_directory = os.path.join(os.getcwd(), "..", "Results", "FPUT5_v7")
...
list_labels = ["CINDy", "SINDy", "FISTA", "IPM", "CINDy (c)", "IPM (c)", r"SR3 (c-$\ell_0$)", r"SR3 (c-$\ell_1$)"]
...
plt.savefig(
    os.path.join(
        os.getcwd(), "..", "Images", "FPUT5_v7","FPUT_" + str(dimension) + "_dim_v7.pdf"
    ),
    bbox_inches="tight",
)
plt.close()
...
list_data = [
    data["BCG_derivative_training"][:max_noise_level] / data["noise"][:, 0][:max_noise_level][:,None],
    data["SINDy_derivative_training"][:max_noise_level] / data["noise"][:, 0][:max_noise_level][:,None],
    data["FISTA_derivative_training"][:max_noise_level] / data["noise"][:, 0][:max_noise_level][:,None],
    data["CVXOPT_derivative_training"][:max_noise_level] / data["noise"][:, 0][:max_noise_level][:,None],
    data["BCG_constraint_derivative_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["CVXOPT_constraint_derivative_training"][:max_noise_level] / data["noise"][:, 0][:max_noise_level][:,None],
    data["SR3_constrained_l0_derivative_training"][:max_noise_level] / data["noise"][:, 0][:max_noise_level][:,None],
    data["SR3_constrained_l1_derivative_training"][:max_noise_level] / data["noise"][:, 0][:max_noise_level][:,None],
    data["exact_derivative_training"][:max_noise_level] / data["noise"][:, 0][:max_noise_level][:,None],
]
list_labels = ["CINDy", "SINDy", "FISTA", "IPM", "CINDy (c)", "IPM (c)", r"SR3 (c-$\ell_0$)", r"SR3 (c-$\ell_1$)", "Exact dynamic"]
colors = ["k", "m", "c", "r", "b", "g",  "tab:orange", 'maroon', "y"]
...
# Plot the difference between exact dynamic and recovered dynamic
list_data = [
    data["BCG_integral_trajectory_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["SINDy_integral_trajectory_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["FISTA_integral_trajectory_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["CVXOPT_trajectory_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["BCG_integral_constraint_trajectory_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["CVXOPT_integral_constraint_trajectory_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["SR3_constrained_l0_integral_trajectory_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["SR3_constrained_l1_integral_trajectory_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["exact_trajectory_training"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
]
plot_stochastic(
    data["noise"][:, 0][:max_noise_level],
    list_data,
...
# Plot the difference between exact dynamic and recovered dynamic
list_data = [
    data["BCG_derivative_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["SINDy_derivative_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["FISTA_derivative_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["CVXOPT_derivative_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["BCG_constraint_derivative_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["CVXOPT_constraint_derivative_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["SR3_constrained_l0_derivative_validation"][:max_noise_level] / data["noise"][:, 0][:max_noise_level][:,None],
    data["SR3_constrained_l1_derivative_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["exact_derivative_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
]
plot_stochastic(
    data["noise"][:, 0][:max_noise_level],
    list_data,
...
# Plot the difference between exact dynamic and recovered dynamic
list_data = [
    data["BCG_integral_trajectory_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["SINDy_integral_trajectory_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["FISTA_integral_trajectory_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["CVXOPT_integral_trajectory_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["BCG_integral_constraint_trajectory_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["CVXOPT_integral_constraint_trajectory_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["SR3_constrained_l0_integral_trajectory_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["SR3_constrained_l1_integral_trajectory_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
    data["exact_trajectory_validation"][:max_noise_level]/ data["noise"][:, 0][:max_noise_level][:,None],
]
plot_stochastic(
    data["noise"][:, 0][:max_noise_level],
    list_data,
