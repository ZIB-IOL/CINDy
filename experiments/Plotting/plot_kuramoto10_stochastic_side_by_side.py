...
file_directory = os.path.join(os.getcwd(), "..", "Results", "kura10_v7")
...
for i in range(len(list_data_right)):
    if list_labels[i] == "CINDy":
        mean = np.min(list_data_right[i], axis=1)
    else:
...
axs[0, 0].legend(fontsize=legend_size, ncol=2)
...
plt.savefig(
    os.path.join(
        ...
        "Images",
        "kura10_v7",
        "kura_" + str(dimension) + "_dim_v7.pdf",
    ),
    bbox_inches="tight",
)
plt.close()
...
plot_stochastic(
    ...
    save_figure=os.path.join(
        ...
        "Images",
        "kura10_v7",
        "kura_differential_training_" + str(dimension) + "_dim_v7.pdf",
    ),
)
plt.close()
...
plot_stochastic(
    ...
    save_figure=os.path.join(
        ...
        "Images",
        "kura10_v7",
        "kura_integral_training_" + str(dimension) + "_dim_v7.pdf",
    ),
)
plt.close()
...
plot_stochastic(
    ...
    save_figure=os.path.join(
        ...
        "Images",
        "kura10_v7",
        "kura_differential_validation_" + str(dimension) + "_dim_v7.pdf",
    ),
)
plt.close()
...
plot_stochastic(
    ...
    save_figure=os.path.join(
        ...
        "Images",
        "kura10_v7",
        "kura_integral_validation_" + str(dimension) + "_dim_v7.pdf",
    ),
)
plt.close()
